var productList = [
  ...
  var para1=document.getElementById("paras");

//   para1.innerHTML=productList[1].name;
 for(var i=0;i<productList.length;i++){
    `<img src="productList[i].preview>
    <p>productList[i].name</p>
    <span>productList[i].brand</span>`
     para1.innerHTML=productList[i].name;
    console.log(productList[i].brand)
